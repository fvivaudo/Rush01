...
public class InputManager : MonoBehaviour 
{
	...
	public delegate void OnKeybindOrderChanged();
	private OnKeybindOrderChanged onOrderChanged = null;
	...
	public void LoadInputFromBinder(InputBinderBase binder, OnKeybindOrderChanged regCallback)
	{
		onOrderChanged += regCallback;
	...
	public void UnloadInputBinder(InputBinderBase binder, OnKeybindOrderChanged unregCallback)
	{
		onOrderChanged += unregCallback;
		List<InputDefinition> defs = binder.GetInputBinds();
		if (defs == null) return;
		if (defs.Count == 0) return;
