...
public class RPGAttribute : ScriptableObject
{
	...
	public float Value {
		get
		{
			if ((_value + Bonus) > MaxValue) return MaxValue;
			return _value + Bonus;
		}
	...
	public float NoBonusMax { get { return _maxValue; } }
	...
	// this will be added to the returned MaxValue
	...
	public void SetWithoutTriggeringEvents(float val, float min, float max, float bonus, float bonusMax)
	{
		Bonus = bonus;
		BonusMax = bonusMax;
		_value = val;
