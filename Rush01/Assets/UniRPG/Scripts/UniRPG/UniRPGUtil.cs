...
public class UniRPGUtil 
{
	...
	{
		if (go.GetComponent<Renderer>()) EditorUtility.SetSelectedWireframeHidden(go.GetComponent<Renderer>(), true);
		for (int i = 0; i < go.transform.childCount; i++)
		{
	...
	private static List<string> asms;
	private static readonly Dictionary<string, System.Type> typeCache = new Dictionary<string, System.Type>();
	...
	public static System.Type FindType(string name)
	{
		...
		{
			System.Type t = null;
			typeCache.TryGetValue(name, out t);
			if (false == object.ReferenceEquals(t, null)) return t;

			t = System.Type.GetType(name);
			if (object.ReferenceEquals(t, null))
			{
				t = System.Type.GetType(name + ",Assembly-CSharp");
				if (object.ReferenceEquals(t, null))
				{
					...
					if (object.ReferenceEquals(t, null))
					{
						...
						if (object.ReferenceEquals(t, null))
						{
							t = System.Type.GetType("UniRPG." + name);
							if (object.ReferenceEquals(t, null))
							{
								t = System.Type.GetType("UniRPG." + name + ",Assembly-CSharp");
								if (object.ReferenceEquals(t, null))
								{
									t = System.Type.GetType("DiaQ." + name);
									if (object.ReferenceEquals(t, null))
									{
										t = System.Type.GetType("DiaQ." + name + ",Assembly-CSharp");
										if (object.ReferenceEquals(t, null))
										{
											#region find
											if (asms == null)
											{
												...
												System.Reflection.Assembly[] a = System.AppDomain.CurrentDomain.GetAssemblies();
												for (int i = 0; i < a.Length; i++)
												{
													asms.Add(a[i].FullName);
												}
											}

											foreach (string s in asms)
											{
												t = System.Type.GetType(name + "," + s);
												if (false == object.ReferenceEquals(t, null)) break;
											}
											...
											if (object.ReferenceEquals(t, null))
											{
												foreach (string s in asms)
												{
													...
													t = System.Type.GetType(ns + "." + name + "," + s);
													if (false == object.ReferenceEquals(t, null)) break;
												}
											}
